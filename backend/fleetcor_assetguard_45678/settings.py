"""
Django settings for fleetcor_assetguard_45678 project.
...
ROOT_URLCONF = 'fleetcor_assetguard_45678.urls'
...
WSGI_APPLICATION = 'fleetcor_assetguard_45678.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fleetcor_assetguard_45678 API",
    "DESCRIPTION": "API documentation for fleetcor_assetguard_45678 App",
    "VERSION": "v1",
}
